import teste_kotlin_fundamental.trocaLetras
...
// Ex. 05
fun trocaLetras2(letra: String) = println(letra.lowercase().replace("a","x"))
// Ex. 05
fun trocaLetras3(letra: String) = println(letra.replace("a","x",true).lowercase())
// Ex. 05
fun trocaLetras4(letra: String) = println(letra.replace("A","x").replace("a", "x").lowercase())